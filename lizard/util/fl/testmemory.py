from pymtl import *
from lizard.pclib.ifcs import InValRdyBundle, OutValRdyBundle
from lizard.pclib.cl import InValRdyRandStallAdapter
from lizard.pclib.cl import OutValRdyInelasticPipeAdapter
...
class TestMemoryFL(Model):
  ...
  def __init__(s, mem_ifc_dtypes, nports=1, size=2**64):
    ...
    s.resps = [OutValRdyBundle(mem_ifc_dtypes.resp) for _ in range(nports)]
