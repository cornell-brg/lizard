...
inline void wprint(wchar_t c) { wprintf(L"%C", c); }
...
inline void wprint(const wchar_t* p) {
...
inline void wprint(const wchar_t* str) { wprintf(L"%S", str); }
