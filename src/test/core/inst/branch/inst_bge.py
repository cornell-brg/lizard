...
def gen_src0_dep_taken_test():
  return [
    gen_br2_src0_dep_test( i, "bge", 7+i, 7, True ) for i in range(0,6)
  ]
...
def gen_src0_dep_nottaken_test():
  return [
    gen_br2_src0_dep_test( i, "bge", i, 7, False ) for i in range(0,6)
  ]
...
def gen_srcs_dep_taken_test():
  return [
    gen_br2_srcs_dep_test( i, "bge", 0xf0, i, True ) for i in range(0,6)
  ]
...
def gen_srcs_dep_nottaken_test():
  return [
    gen_br2_srcs_dep_test( i, "bge", i, i+1, False ) for i in range(0,6)
  ]
