...
def gen_dest_dep_test():
  return [
    gen_rr_dest_dep_test( i, "sll", 3-i, i, Bits(32, (3-i) << i).uint() ) for i in range(0, 6)
  ]
...
def gen_src0_dep_test():
  return [
    gen_rr_src0_dep_test( i, "sll", 7+i, 1, Bits(32, (7+i) << 1).uint() ) for i in range(0, 6)
  ]
...
def gen_src1_dep_test():
  return [
    gen_rr_src1_dep_test( i, "sll", 3-i, i, Bits(32, (3-i) << i).uint() ) for i in range(0, 6)
  ]
...
def gen_srcs_dep_test():
  return [
    gen_rr_srcs_dep_test( i, "sll", 3-i, i, Bits(32, (3-i) << i).uint() ) for i in range(0, 6)
  ]
