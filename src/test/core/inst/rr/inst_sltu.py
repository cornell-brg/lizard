...
def gen_dest_dep_test():
  return [
    gen_rr_dest_dep_test( i, "sltu", 6-i, 4, 1 if (6-i) < 4 else 0 ) for i in range(0, 6)
  ]
...
def gen_src0_dep_test():
  return [
    gen_rr_src0_dep_test( i, "sltu", 6-i, 4, 1 if (6-i) < 4 else 0 ) for i in range(0, 6)
  ]
...
def gen_src1_dep_test():
  return [
    gen_rr_src1_dep_test( i, "sltu", 6-i, 4, 1 if (6-i) < 4 else 0 ) for i in range(0, 6)
  ]
...
def gen_srcs_dep_test():
  return [
    gen_rr_srcs_dep_test( i, "sltu", 6-i, 4, 1 if (6-i) < 4 else 0 ) for i in range(0, 6)
  ]
