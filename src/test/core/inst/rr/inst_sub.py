...
def gen_dest_dep_test():
  return [
    gen_rr_dest_dep_test( i, "sub", 6-i, 1, (6-i) - 1 ) for i in range(0, 6)
  ]
...
def gen_src0_dep_test():
  return [
    gen_rr_src0_dep_test( i, "sub", 7+i, 1, (7+i) - 1 ) for i in range(0, 6)
  ]
...
def gen_src1_dep_test():
  return [
    gen_rr_src1_dep_test( i, "sub", 1, 13+i, 1 - (13+i) ) for i in range(0, 6)
  ]
...
def gen_srcs_dep_test():
  return [
    gen_rr_srcs_dep_test( i, "sub", 12+i, 1+i, (12+i) - (1+i) ) for i in range(0, 6)
  ]
