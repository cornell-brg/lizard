...
def gen_dest_dep_test():
  return [
    gen_rimm_dest_dep_test( i, "addi", 10-i, 3-i, (10-i) + (3-i) ) for i in range(0, 6)
  ]
...
def gen_src_dep_test():
  return [
    gen_rimm_src_dep_test( i, "addi", 10-i, 3-i, (10-i) + (3-i) ) for i in range(0, 6)
  ]
...
def gen_srcs_dest_test():
  return [
    gen_rimm_src_eq_dest_test( "addi", 10-i, 3-i, (10-i) + (3-i) ) for i in range(0, 6)
  ]
