...
def gen_dest_dep_test():
  return [
    gen_rimm_dest_dep_test( i, "slti", 2-i, 1, 1 if (2-i) < 1 else 0 ) for i in range(0, 6)
  ]
...
def gen_src_dep_test():
  return [
    gen_rimm_src_dep_test( i, "slti", 1-i, -1, 1 if (1-i) < -1 else 0 ) for i in range(0, 6)
  ]
...
def gen_srcs_dest_test():
  return [
    gen_rimm_src_eq_dest_test( "slti", 12-i, 10, 1 if (12-i) < 10 else 0 ) for i in range(0, 6)
  ]
