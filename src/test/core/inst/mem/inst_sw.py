...
def gen_dest_dep_test():
  return [
    gen_st_dest_dep_test( i, "sw", 0x2000 + i*4, (i*4 << 3)+12 ) for i in range(0,6)
  ]
...
def gen_base_dep_test():
  return [
    gen_st_base_dep_test( i, "sw", 0x2000 + i*4, (i*4 << 3)+12 ) for i in range(0,6)
  ]
...
def gen_data_dest_test():
  return [
    gen_st_data_dep_test( i, "sw", 0x2000 + i*4, (i*4 << 3)+12 ) for i in range(0,6)
  ]
