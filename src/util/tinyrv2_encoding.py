...
[
    ...
    [ "ld     rd, i_imm(rs1)",  0b00000000000000000111000001111111, 0b00000000000000000011000000000011 ], # I-type, tinyrv{1,2}
    ...
    [ "lwu    rd, i_imm(rs1)",  0b00000000000000000111000001111111, 0b00000000000000000110000000000011 ], # I-type, tinyrv{1,2}
    ...
    [ "sd     rs2, s_imm(rs1)",  0b00000000000000000111000001111111, 0b00000000000000000011000000100011 ], # S-type, tinyrv{1,2}
    ...
    # Jump & Link
    [ "j      j_imm",            0b00000000000000000000111111111111, 0b00000000000000000000000001101111 ], # UJ-type, tinyrv{1,2}
